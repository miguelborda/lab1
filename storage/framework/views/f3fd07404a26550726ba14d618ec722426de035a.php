  ...
  <!--<div style="text-align: center;">
    ...
    <table class="table table-striped numsolicitud">
        <thead class="cabecera">          
          ...
          <th class=cabnsol2 style="text-align:center"><?php echo e($formulario1s->num_solicitud); ?></th>
          <th class=cabfsol style="text-align:left">Fecha Solicitud:</th>
          <th class=cabfsol2 style="text-align:center"><?php echo e($formulario1s->fecha_solicitud); ?></th>
    ...
    <table class="table table-striped">
        <thead class="cabecera">                    
            <th class=cabregional style="text-align:left">Secretaria Regional:</th>
            <th class=cabregional2 style="text-align:center"><?php echo e($secretaria->nom_secretaria_regional); ?></th>          
        ...
        <thead class="cabecera establecim">                    
            ...
            <th class=cabestablecimiento2 style="text-align:left" colspan="3"><?php echo e($establecimiento->nombre_establecimiento); ?></th>          
        </thead>  
    </table>
    ...
    <table class="table table-striped numsolicitud">      
      ...
      <tr>
        ...
        <h4 class="text-center" style="font-size: 12px;">CITOTECNÓLOGO(A)</h4>        
      </table>  
