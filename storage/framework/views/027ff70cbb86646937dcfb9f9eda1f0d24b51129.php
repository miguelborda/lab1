				...
				<div class="table-wrapper table-responsive">
		            <table class="table hover" id="myTable">
		              ...
		              <tbody>
		                ...
		                <tr>
		                  <td class="min-width">
		                    <p><?php echo e($secretariaregional->codigo_regional); ?></p>
		                  </td>
		                  <td class="min-width">
						  ...
						  <td width="15px">
                            <form action="<?php echo e(route('patologia.secretariaregional.destroy',$secretariaregional->id)); ?>" method="POST">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\usuariosHB2\resources\views/patologia/secretariaregional/index.blade.php ENDPATH**/ ?>