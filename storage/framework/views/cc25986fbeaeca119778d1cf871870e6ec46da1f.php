...
<body>
  <div style="text-align: center;">
    ...
    <h1 class="text-center">LISTADO DE SERVICIOS</h1><br>
    <table class="table table-striped">
        <thead class="cabecera">
          <tr>
              <th style="text-align: center"><h6>ID SERVICIO</h6></th>
...
<?php /**PATH C:\xampp\htdocs\usuariosHB\resources\views/patologia/servicios/pdf.blade.php ENDPATH**/ ?>