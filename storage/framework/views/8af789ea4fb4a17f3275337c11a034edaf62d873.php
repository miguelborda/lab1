...
<?php $__env->startSection('title', 'Informesf3citos'); ?>
					...
					<thead>
		              ...
		              <tbody>				  	
		                ...
		                <tr>		                  
						  ...
						  <td width="15px">				  
						  <a href="<?php echo e(route('patologia.resultadof3citos.pdf', ['id' => $infor->id])); ?>" class="btn btn-success btn-lg" target="_blank">Imprimir</a> 
                          </td>							
		                </tr>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\usuariosHB\resources\views/patologia/resultadof3citos/index2.blade.php ENDPATH**/ ?>