  ...
  <!--<div style="text-align: center;">
    ...
    <table class="table table-striped numsolicitud">
        <thead class="cabecera">          
          ...
          <th class=cabnsol2 style="text-align:center"><?php echo e($formulario3citos->num_solicitud); ?></th>
          <th class=cabfsol style="text-align:left">Fecha Solicitud:</th>
          <th class=cabfsol2 style="text-align:center"><?php echo e($formulario3citos->fecha_solicitud); ?></th>
    ...
    <table class="table table-striped">
        ...
        <table class="table table-striped">
            <thead class="cabecerawhite numsolicitud">
                ...
                <tr>
                    <td style="text-align: left"><?php echo e($resultado->descripcion); ?></td>                  
                </tr><br>
            </thead>
            <thead class="cabecerawhite numsolicitud">
                <tr>
                ...
                <tr>
                    <td style="text-align: left"><?php echo e($resultado->conclusion); ?></td>                  
                </tr><br>
            </thead>
            <thead class="cabecerawhite numsolicitud">
                <tr>
                ...
                <tr>
                    <td style="text-align: left"><?php echo e($resultado->nota); ?></td>                  
                </tr>
            </thead>
...
<?php /**PATH C:\xampp\htdocs\usuariosHB\resources\views/patologia/resultadof3citos/pdf.blade.php ENDPATH**/ ?>