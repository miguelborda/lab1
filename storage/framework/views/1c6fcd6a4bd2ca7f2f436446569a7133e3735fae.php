...
<?php $__env->startSection('title', 'Crear Formulario2'); ?>
    ...
    <div class="row align-items-center" style="height: 60px">
        <div class="col-md-12">
            <div class="titlemb-30">
                <h2>Crear Formulario Solicitud URBANO</h2>
...
<div class="card">
    <div class="card-body">
        <?php echo Form::open(['route'=>'patologia.formulario2.store']); ?>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <?php echo Form::text('num_solicitud', isset($formulario2) ? $formulario2->num_solicitud : '', ['class' => 'form-control', 'placeholder' => 'Ingrese Numero de Formulario']); ?>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <?php echo Form::date('fecha_solicitud', isset($formulario2) ? $formulario2->fecha_solicitud : '', ['max' => now()->toDateString(), 'min' => '1900-01-01']); ?>               
    ...
    <div class="row custom-bg">        
        <div class="col-md-4">            
            <div class="form-group">
                ...
                <?php echo Form::select('distrito_id', $distritos, isset($formulario2) ? $formulario2->distrito_id : null, ['class' => 'form-control', 'placeholder' => 'Selecciona un Distrito']); ?>
        ...
        <div class="col-md-4">            
            <div class="form-group">
                ...
                <?php echo Form::select('area_id', $areas, isset($formulario2) ? $formulario2->area_id : null, ['class' => 'form-control', 'placeholder' => 'Selecciona una Area']); ?>
        ...
        <div class="col-md-4">            
            <div class="form-group">
                ...
                <?php echo Form::select('sector_id', $sectors, isset($formulario2) ? $formulario2->sector_id : null, ['class' => 'form-control', 'placeholder' => 'Selecciona un Sector']); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\usuariosHB\resources\views/patologia/formulario2/create.blade.php ENDPATH**/ ?>