...
<?php $__env->startSection('title', 'Crear Formulario 3cito'); ?>
...
<div class="card">
    <div class="card-body">
        <?php echo Form::open(['route'=>'patologia.formulario3cito.store']); ?>        
        <div class="row">
            <div class="col-md-3">
                <div class="form-group">
                    <strong><?php echo Form::label('num_solicitud', 'Numero de Solicitud'); ?></strong>
                    <?php echo Form::text('num_solicitud', isset($formulario3cito) ? $formulario3cito->num_solicitud : '', ['class' => 'form-control', 'placeholder' => 'Ingrese Numero de Formulario']); ?>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <?php echo Form::date('fecha_solicitud', isset($formulario3cito) ? $formulario3cito->fecha_solicitud : '', ['max' => now()->toDateString(), 'min' => '1900-01-01']); ?>               
    ...
    <div class="row custom-bg">        
        <div class="col-md-5">            
            <div class="form-group">
                ...
                <?php echo Form::select('establecimiento_id', $establecimientos, isset($formulario3cito) ? $formulario1->establecimiento_id : null, ['class' => 'form-control', 'placeholder' => 'Selecciona un Establecimiento']); ?>
        ...
        <div class="col-md-5">            
            <div class="form-group">
                ...
                <?php echo Form::select('municipio_id', $municipios, isset($formulario3cito) ? $formulario3cito->municipio_id : null, ['class' => 'form-control', 'placeholder' => 'Selecciona un Municipio']); ?>
    ...
    <div class="row custom-bg">
        <div class="col-md-5">            
            <div class="form-group">
                ...
                <?php echo Form::select('area_id', $areas, isset($formulario3cito) ? $formulario3cito->area_id : null, ['class' => 'form-control', 'placeholder' => 'Selecciona una Area']); ?>
        ...
        <div class="col-md-5">            
            <div class="form-group">
                ...
                <?php echo Form::select('distrito_id', $distritos, isset($formulario3cito) ? $formulario3cito->distrito_id : null, ['class' => 'form-control', 'placeholder' => 'Selecciona un Distrito']); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\usuariosHB\resources\views/patologia/formulario3cito/create.blade.php ENDPATH**/ ?>