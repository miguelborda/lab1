<?php $__env->startSection('title', 'Crear Detalle Paciente F1s'); ?>
...
<div class="card">
    <div class="card-body">
        <?php echo Form::open(['route'=>'patologia.detallef1s.store']); ?>
            ...
            <div class="form-group">
                ...
                <?php echo Form::text('nombre', isset($detallef1s) ? $detallef1s->nombre : '', ['class' => 'form-control', 'placeholder' => 'Ingrese Nombre']); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\usuariosHB\resources\views/patologia/detallef1s/create.blade.php ENDPATH**/ ?>