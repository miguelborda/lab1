...
<div class="card">
    <div class="card-body">
        <?php echo Form::open(['route'=>'patologia.resultadof2s.store']); ?>        
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="alert alert-success">
                ...
                <a href="<?php echo e(route('patologia.resultadof2s.pdf')); ?>" class="btn btn-success btn-lg" target="_blank">Imprimir Informe</a> 
            <?php endif; ?>
...
$(document).ready(function() {
    ...
    $('.examen').change(function() {
        ...
        console.log(valorinput);
            $.ajax({
                url: '<?php echo e(route('buscardatosf2.examen')); ?>',
                type:'GET',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\usuariosHB\resources\views/patologia/resultadof2s/create.blade.php ENDPATH**/ ?>