...
<body>
  <table style="width: 100%; border-top: 2px solid black;">
    ...
    <tr>      
      <th class="text-center" style="margin-top: 0;">Resultado Informe Citológico</th>     
    </tr>
  </table>
  <!--<div style="text-align: center;">
    ...
    <table class="table table-striped numsolicitud">
        <thead class="cabecera">          
          ...
          <th class=cabnsol2 style="text-align:center">{{$formulario3citos->num_solicitud}}</th>
          <th class=cabfsol style="text-align:left">Fecha Solicitud:</th>
          <th class=cabfsol2 style="text-align:center">{{$formulario3citos->fecha_solicitud}}</th>
          ...
          <th class=cab2 style="text-align:center">{{$resultado->fecha_resultado}}</th>
        </thead>        
    </table>    
    <table class="table table-striped numsolicitud">      
        <tr>        
            <th class=cabdistrito style="text-align:left">Servicio:</th>
            <td class=cabdistrito2 style="text-align:center">{{$servicio->nombre_servicio}}</td> 
        </tr>        
        <tr>        
            <th class=cabdistrito style="text-align:left">Medico Solicitante:</th>
            <td class=cabdistrito2 style="text-align:center">{{$medico->nombre}},  {{$medico->apellido}}</td>                        
        </tr>
    </table>
    <table class="table table-striped numsolicitud">      
      <tr>
    ...
    <table class="table table-striped">
        <thead class="cabecera">                                
            ...
            <td class=cabdistrito2 style="text-align:center">{{$resultado->diagnostico_clinico}}</td>
        </thead>          
        <thead class="cabecera">                                
            <th class=cabdistrito style="text-align:left">Datos Relevantes:</th>
            <td class=cabdistrito2 style="text-align:center">{{$resultado->datos_relevantes}}</td>
        </thead>          
    </table>
        <h4 class="text-center">RESULTADOS:</h4>
        <table class="table table-striped">
            <thead class="cabecerawhite numsolicitud">
                <tr>
                    <th style="text-align: left">Descripción:</th>                  
                </tr>            
                <tr>
                    <td style="text-align: left">{{$resultado->descripcion}}</td>                  
                </tr><br>
            </thead>
            <thead class="cabecerawhite numsolicitud">
                <tr>
                ...
                <tr>
                    <td style="text-align: left">{{$resultado->conclusion}}</td>                  
                </tr><br>
            </thead>
            <thead class="cabecerawhite numsolicitud">
                <tr>
                ...
                <tr>
                    <td style="text-align: left">{{$resultado->nota}}</td>                  
                </tr>
            </thead>
            
        </table><br><br><br><br>
      </table>
        <h4 class="text-center" style="font-size: 12px;">MÉDICO PATÓLOGO</h4>        
      </table>  
