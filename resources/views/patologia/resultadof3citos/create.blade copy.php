...
@section('title', 'Crear Formulario3')
@push('style')
    ...
    <div class="row align-items-center" style="height: 60px">
        <div class="col-md-6">
            <div class="titlemb-30">
                <h2>Crear Resultado de Formulario3citos</h2>
            </div>
        </div>
    </div>
    <!-- end row -->
        ...
        <div class="row custom-bg">
            ...
            <div class="col-md-2-5">
                <div class="form-group">
                    ...
                    {!! Form::date('fecha_resultado', isset($formulario3cito) ? $resultadof3citos->fecha_resultado : '', ['max' => now()->toDateString(), 'min' => '1900-01-01']) !!}               
