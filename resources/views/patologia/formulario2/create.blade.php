...
<div class="card">
    <div class="card-body">
        {!! Form::open(['route'=>'patologia.formulario2.store']) !!}
        
        <div class="row">
            <div class="col-md-3">
                <div class="form-group">
                    <strong>{!! Form::label('num_solicitud', 'Numero de Solicitud') !!}</strong>
                    {!! Form::text('num_solicitud', isset($formulario2) ? $formulario2->num_solicitud : '', ['class' => 'form-control', 'placeholder' => 'Ingrese Numero de Formulario']) !!}
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    {!! Form::date('fecha_solicitud', isset($formulario2) ? $formulario2->fecha_solicitud : '', ['max' => now()->toDateString(), 'min' => '1900-01-01']) !!}               
    ...
    <div class="row custom-bg">        
        <div class="col-md-4">            
            <div class="form-group">
                ...
                {!! Form::select('distrito_id', $distritos, isset($formulario2) ? $formulario2->distrito_id : null, ['class' => 'form-control', 'placeholder' => 'Selecciona un Distrito']) !!}
        ...
        <div class="col-md-4">            
            <div class="form-group">
                ...
                {!! Form::select('area_id', $areas, isset($formulario2) ? $formulario2->area_id : null, ['class' => 'form-control', 'placeholder' => 'Selecciona una Area']) !!}
        ...
        <div class="col-md-4">            
            <div class="form-group">
                ...
                {!! Form::select('sector_id', $sectors, isset($formulario2) ? $formulario2->sector_id : null, ['class' => 'form-control', 'placeholder' => 'Selecciona un Sector']) !!}
